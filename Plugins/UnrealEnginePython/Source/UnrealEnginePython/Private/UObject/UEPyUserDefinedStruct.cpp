...
PyObject *py_ue_struct_move_variable_up(ue_PyUObject * self, PyObject * args)
{
	...
	if (FStructureEditorUtils::MoveVariable(u_struct, *guid, *guid, FStructureEditorUtils::EMovePosition::PositionAbove))
	{
		Py_RETURN_TRUE;
	}
...
PyObject *py_ue_struct_move_variable_down(ue_PyUObject * self, PyObject * args)
{
	...
	if (FStructureEditorUtils::MoveVariable(u_struct, *guid, *guid, FStructureEditorUtils::EMovePosition::PositionBelow))
	{
		Py_RETURN_TRUE;
	}
