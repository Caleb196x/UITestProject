...
#else
	return PyUnicode_FromString(TCHAR_TO_UTF8(*FPaths::Pro()));
#endif*/
	return PyUnicode_FromString(TCHAR_TO_UTF8(*FPaths::ProjectContentDir()));
}
...
PyObject *py_unreal_engine_object_path_to_package_name(PyObject * self, PyObject * args)
{
	...
	return PyUnicode_FromString(TCHAR_TO_UTF8(FPackageName::ObjectPathToPackageName(FWideStringView(UTF8_TO_TCHAR(path))).GetData()));
}
