...
template <typename T> T *ue_py_check_type(PyObject *py_obj)
{
	...
	if (!ue_py_obj->ue_object || !ue_py_obj->ue_object->IsValidLowLevel() || ue_py_obj->ue_object->IsGarbageEliminationEnabled())
	{
...
{
	if (!py_obj->ue_object || !py_obj->ue_object->IsValidLowLevel() || py_obj->ue_object->IsGarbageEliminationEnabled())
	{
