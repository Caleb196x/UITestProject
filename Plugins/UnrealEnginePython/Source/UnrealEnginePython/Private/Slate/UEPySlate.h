...
#define ue_py_slate_setup_argument_slot_args(_type, _swidget_ref) _type::FScopedWidgetSlotArguments arguments = _swidget_ref->AddSlot();\
	TArray<TSharedRef<FPythonSlateDelegate>> DeferredSlateDelegates;\
	ue_py_slate_farguments_required_slot("widget");
...
#define ue_py_slate_setup_argument_slot_args_grid(_type, _swidget_ref, column, row, layer) _type::FScopedWidgetSlotArguments arguments = _swidget_ref->AddSlot(column, row, layer);\
TArray<TSharedRef<FPythonSlateDelegate>> DeferredSlateDelegates;\
ue_py_slate_farguments_required_slot("widget");
