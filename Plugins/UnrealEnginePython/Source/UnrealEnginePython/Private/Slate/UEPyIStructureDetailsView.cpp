...
static int ue_py_istructure_details_view_init(ue_PyIStructureDetailsView *self, PyObject *args, PyObject *kwargs)
{
	...
	view_args.bAllowSearch = (py_allow_search) ? static_cast<bool>(PyObject_IsTrue(py_allow_search)) : view_args.bAllowSearch;
	view_args.bUpdatesFromSelection = (py_update_from_selection) ? static_cast<bool>(PyObject_IsTrue(py_update_from_selection)) : view_args.bUpdatesFromSelection;
	view_args.bLockable = (py_lockable) ? static_cast<bool>(PyObject_IsTrue(py_lockable)) : view_args.bLockable;
	view_args.bHideSelectionTip = (py_hide_selection_tip) ? static_cast<bool>(PyObject_IsTrue(py_hide_selection_tip)) : view_args.bHideSelectionTip;
	view_args.bSearchInitialKeyFocus = (py_search_initial_key_focus) ? static_cast<bool>(PyObject_IsTrue(py_search_initial_key_focus)) : view_args.bSearchInitialKeyFocus;
