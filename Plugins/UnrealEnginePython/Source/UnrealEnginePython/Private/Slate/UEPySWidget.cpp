...
static PyObject *py_ue_swidget_bind_up_mouse_button_up(ue_PySWidget *self, PyObject * args)
{
	PyObject *py_callable;
...
static PyMethodDef ue_PySWidget_methods[] = {
	...
	{ "bind_on_mouse_button_up", (PyCFunction)py_ue_swidget_bind_up_mouse_button_up, METH_VARARGS, "" },
