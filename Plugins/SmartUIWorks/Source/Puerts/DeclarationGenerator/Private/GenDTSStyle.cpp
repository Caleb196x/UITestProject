...
FName FGenDTSStyle::GetStyleSetName()
{
    static FName StyleSetName(TEXT("GenDTSStyle"));
    return StyleSetName;
}
...
void FGenDTSStyle::ReloadTextures()
{
...
const ISlateStyle& FGenDTSStyle::Get()
{
