...
struct FReactDeclarationGenerator : public FTypeScriptDeclarationGenerator
{
    ...
    static FString GetPluginContentDir(const FString& PluginName = TEXT("SmartUIWorks"))
    {
...
void FReactDeclarationGenerator::GenReactDeclaration()
{
    ...
    FFileHelper::SaveStringToFile(ToString(), *(GetPluginContentDir() / TEXT("TypeScript/Typing/react-umg/index.d.ts")),
        FFileHelper::EEncodingOptions::ForceUTF8WithoutBOM);
    FFileHelper::SaveStringToFile(Components, *(GetPluginContentDir() / TEXT("JavaScript/react-umg/components.js")),
        FFileHelper::EEncodingOptions::ForceUTF8WithoutBOM);
}
