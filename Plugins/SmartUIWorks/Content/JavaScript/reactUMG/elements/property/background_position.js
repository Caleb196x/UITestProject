...
function isDirectionKeyword(value) {
...
function parseTwoValueRules(parts, result) {
    if (parts.length !== 2) {
        ...
        if (axis.type === "horizontal") {
            ...
            if (isHorizontal) {
                ...
                if (axis.value === "center") {
                    ...
                    result.padding.Left = (0, common_utils_1.convertLengthUnitToSlateUnit)(axis.value, undefined);
                    result.padding.Right = 0;
                }
            }
            else {
                ...
                if (axis.value === "center") {
                    ...
                    result.padding.Top = (0, common_utils_1.convertLengthUnitToSlateUnit)(axis.value, undefined);
                    result.padding.Bottom = 0;
                }
            }
        }
...
function parseThreeAndFourValueRules(parts, result) {
    ...
    const isAxisCompatible = (k1, k2) => (isHorizontalKeyword(k1) && isVerticalKeyword(k2)) ||
    ...
    const applyAxis = ({ key, offset }, isHorizontal) => {
        if (isHorizontal) {
            ...
            switch (key) {
                case 'left':
                    result.padding.Left = (0, common_utils_1.convertLengthUnitToSlateUnit)(offset, undefined);
                    result.padding.Right = 0;
                    break;
                case 'right':
                    result.padding.Right = (0, common_utils_1.convertLengthUnitToSlateUnit)(offset, undefined);
                    result.padding.Left = 0;
                    break;
                case 'center':
                    result.padding.Left = (0, common_utils_1.convertLengthUnitToSlateUnit)(offset, undefined);
            ...
            switch (key) {
                case 'top':
                    result.padding.Top = (0, common_utils_1.convertLengthUnitToSlateUnit)(offset, undefined);
                    result.padding.Bottom = 0;
                    break;
                case 'bottom':
                    result.padding.Bottom = (0, common_utils_1.convertLengthUnitToSlateUnit)(offset, undefined);
                    result.padding.Top = 0;
                    break;
                case 'center':
                    result.padding.Top = (0, common_utils_1.convertLengthUnitToSlateUnit)(offset, undefined);
...
function parseBackgroundPosition(backgroundPosition) {
    ...
    if (parts.length === 1) {
        if (isDirectionKeyword(parts[0])) {
            ...
            result.horizontal = UE.EHorizontalAlignment.HAlign_Fill;
            result.vertical = UE.EVerticalAlignment.VAlign_Center;
            const length = (0, common_utils_1.convertLengthUnitToSlateUnit)(parts[0], undefined);
...
//# sourceMappingURL=background_position.js.map