...
function parseHex(hex) {
    ...
    const expanded = hexClean.length === 3 || hexClean.length === 4
        ...
        : hexClean;
    const parseChannel = (start, end) => parseInt(expanded.slice(start, end), 16) || 0;
    return {
        r: parseChannel(0, 2),
        g: parseChannel(2, 4),
        b: parseChannel(4, 6),
...
// 辅助函数
const parseComponent = (s) => (0, common_utils_1.safeParseFloat)(s.replace('%', ''));
...
//# sourceMappingURL=color_parser.js.map