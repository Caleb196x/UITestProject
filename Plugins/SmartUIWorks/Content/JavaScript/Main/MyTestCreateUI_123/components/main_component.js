...
class MainComponent extends React.Component {
    ...
    render() {
        return React.createElement(reactUMG_1.VerticalBox, null,
            ...
            React.createElement(reactUMG_1.HorizontalBox, null,
                React.createElement(reactUMG_1.Button, { OnClicked: () => this.handleLogin(), RenderTransform: { Translation: { X: 100, Y: 100 } } }, 'Login'),
            ...
            React.createElement("div", { style: { display: 'flex', flexDirection: 'row', alignItems: 'center', justifyContent: 'center' } },
                ...
                React.createElement("button", { style: { alignSelf: 'satrt' }, onClick: () => { this.setState({ progressVal: Math.max(this.state.progressVal - 5, 0) }); } }, "\u51CF\u5C11\u8FDB\u5EA6"),
                React.createElement("div", { style: { overflow: 'scroll', scrollbarWidth: 'thin', scrollPadding: '5px', justifyContent: 'space-between' } },
                    ...
                    React.createElement("text", { style: { width: '100%', height: '100%' } }, "scroll-7"),
                    React.createElement("text", { style: { width: '100%', height: '100%' } }, "scroll-8"),
                    React.createElement("text", { style: { width: '100%', height: '100%' } }, "scroll-9"),
                    React.createElement("text", { style: { width: '100%', height: '100%' } }, "scroll-10"),
                    React.createElement("text", { style: { width: '100%', height: '100%' } }, "scroll-11"),
                    React.createElement("text", { style: { width: '100%', height: '100%' } }, "scroll-12"),
                    React.createElement("text", { style: { width: '100%', height: '100%' } }, "scroll-13"))),
