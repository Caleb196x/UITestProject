...
export class BackgroundPositionTest extends React.Component<BackgroundPositionTestProps> {
    ...
    render() {
        return (
            <div style={{ display: 'flex', flexDirection: 'column', width: '600px', height: '600px', backgroundColor: 'red'}}>
                <div style={{ backgroundImage: `url(${face})`, backgroundColor: '#45a0a0', backgroundPosition: 'top left', color: 'rgba(87, 161, 3, 0.7)'}}>
                    <span>top left Position Test rgb(143, 3, 3)</span>
                </div>
                <div style={{ backgroundPosition: 'top center', color: 'rgba(3, 27, 161, 0.7)'}}>
                    <span>top center Position Test</span>
                </div>
                <div style={{ backgroundPosition: 'top right', color: 'rgba(203, 18, 11, 0.7)'}}>
                    <span>top right Position Test</span>
                </div>
                <div style={{ backgroundPosition: 'left right', color: 'rgba(186, 8, 240, 0.7)'}}>
                ...
                <div style={{ backgroundPosition: 'left bottom 25px', color: 'rgba(176, 72, 72, 0.7)'}}>
